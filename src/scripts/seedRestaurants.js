...
var restaurant_1 = __importDefault(require("@/models/restaurant")); // لو بتستخدم ES modules
function seed() {
    return __awaiter(this, void 0, void 0, function () {
        var existing, newRestaurant, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, restaurant_1.default.findOne({ subdomain: "example-restaurant" })];
                case 2:
                    existing = _a.sent();
                    if (existing) {
                    ...
                    newRestaurant = new restaurant_1.default({
                        name: {
                            ar: "مطعم مثال",
