...
<CardTitle className="text-lg text-gray-900">Способ оплаты</CardTitle>
<CardDescription className="text-xs text-gray-500">Выберите удобный способ оплаты заказа.</CardDescription>
</CardHeader>
