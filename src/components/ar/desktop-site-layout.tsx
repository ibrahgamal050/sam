      ...
      <header className="sticky top-0 z-30 bg-white/90 backdrop-blur border-b">
        <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2">
            <NavLink href="/ar" label="الرئيسية" />
            <NavLink href="/ar/menu" label="المنيو" icon={<Utensils className="h-4 w-4" />} />
            <NavLink href="/ar/branches" label="الفروع" icon={<Map className="h-4 w-4" />} />
            <NavLink href="/ar/about" label="عن المطعم" icon={<Info className="h-4 w-4" />} />
          </nav>
        </div>
      </header>
