...
export default function PickupTab({ branches, pickupBranch, onSelectBranch }: PickupTabProps) {
  ...
  return (
    <div className="divide-y">
      {branches.map((b: any) => {
        ...
        const name = b?.name?.ar || b?.name?.en || b?.name || "فرع بدون اسم"
        const address = b?.address?.ar || b?.address?.en || b?.address || "بدون عنوان"
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="text-right">
                <div className="flex items-center gap-2">
                  ...
                  {b?.isMainBranch && (
                    <Badge className="bg-[#6c5ce7] text-white">الفرع الرئيسي</Badge>
                  )}
