  ...
  return (
    ...
    >
      <div className="mb-6">
        ...
        <h2 className="mt-2 text-2xl font-semibold text-gray-900">الأقسام</h2>
      </div>
            ...
            return (
              <li key={categoryId}>
                <button
                  ...
                  className={`w-full text-right px-4 py-2.5 text-sm font-semibold rounded-2xl transition-all duration-200 ${
                    isActive
      ...
      <div className="mt-8 rounded-2xl border border-gray-100 bg-[#f7f9fc] px-4 py-5 text-sm text-gray-600">
        <p className="mb-2 font-semibold text-gray-800">نصيحة</p>
        <p>اختر القسم للتنقل بسرعة بين الأطباق المتاحة وإضافتها إلى السلة.</p>
      </div>
    </aside>
  )
})
