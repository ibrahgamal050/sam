  ...
  return (
    <div className="container mx-auto p-4 text-center" dir="rtl">
      ...
      <div className="space-x-0 space-y-2">
        <Link href={`/ru/order/${orderId}`} className="inline-block bg-[#6C5CE7] text-white px-4 py-2 rounded hover:bg-[#5A4BD1]">عرض تفاصيل الطلب</Link>
        <div className="mt-3">
          <button onClick={() => router.push('/ru/menu')} className="text-[#6C5CE7] hover:underline">العودة إلى المنيو</button>
        </div>
      </div>
    </div>
  )
