      ...
      <header className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">
            {totalQuantity > 0 ? `${totalQuantity} item${totalQuantity !== 1 ? 's' : ''}` : "No items added yet"}
          </p>
        </div>
        {items.length > 0 && (
          <button
        ...
        {items.length === 0 ? (
          <div className="flex h-full flex-col items-center justify-center gap-4 text-center text-gray-500">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-gray-500">Start adding your favorite dishes from the menu</p>
            </div>
          </div>
        ) : (
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-gray-500">
                      {formatValue(item.unitPrice)} {currency} per item
                    </p>
                  </div>
