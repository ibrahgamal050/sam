        ...
        <div className="mx-auto flex w-full max-w-5xl flex-col gap-8 px-4 py-16 text-center sm:px-6">
          <div className="relative overflow-hidden rounded-[32px] border border-gray-200 bg-gradient-to-br from-[#f7f9fc] to-white p-12 shadow-[0_25px_60px_-35px_rgba(15,23,42,0.35)]">
            ...
            <div className="relative space-y-4">
              ...
              <h1 className="text-3xl font-bold text-gray-900">No branches added yet</h1>
              <p className="mx-auto max-w-2xl text-sm leading-7 text-gray-600">
                Restaurant branches will be displayed once added. Stay tuned to discover our new locations and delivery services available in your area.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="relative grid gap-8 p-8 lg:grid-cols-[minmax(0,1fr)_300px] lg:p-12">
            <div className="space-y-6">
              <div className="inline-flex items-center gap-3 rounded-full bg-black/5 px-4 py-2 text-xs font-semibold text-gray-600">
                ...
                {branches.length} {branches.length === 1 ? "branch available" : "branches available"}
              </div>
              <div className="flex flex-wrap items-center gap-4">
                ...
                <div>
                  <h1 className="text-3xl font-bold leading-tight text-gray-900 sm:text-4xl">{restaurantName} Branches</h1>
                  <p className="mt-2 text-sm text-gray-600">
                    Choose the branch closest to you for direct contact and available delivery services.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-3xl border border-gray-200 bg-white/80 p-6 shadow-[0_20px_45px_-35px_rgba(15,23,42,0.5)] backdrop-blur">
              <h2 className="text-base font-semibold text-gray-800">Key Services</h2>
              <ul className="mt-5 space-y-4 text-sm text-gray-600">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">All branches operate daily to meet your needs throughout the day.</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#f7f9fc] text-gray-700">
                  ...
                  <div>
                    <p className="font-semibold text-gray-800">Strategic Locations</p>
                    <p className="text-xs text-gray-500">Choose your preferred branch with easy access and available delivery.</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#f7f9fc] text-gray-700">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">Our team is ready to answer your inquiries and handle special orders.</p>
                  </div>
                </li>
              </ul>
            </div>
        ...
        <section className="mt-12 space-y-6">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="space-y-2">
              <h2 className="text-2xl font-semibold text-gray-900">Explore Our Branches</h2>
              <p className="text-sm text-gray-600">Pick the branch nearest to you for contact details and delivery options.</p>
            </div>
          </div>

          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            {branches.map((branch) => {
              const branchName = branch.name?.en || branch.name?.ar || "Branch"
              const branchKey = branch._id ? branch._id.toString() : `${branchName}-${branch.phone ?? ""}`
              const branchImage = resolveImageSrc(restaurant.logo)
              const branchAddress = branch.location?.address?.en || branch.location?.address?.ar || "Address not available"
              ...
              return (
                ...
                >
                  <div className="relative h-40 w-full overflow-hidden">
                    <Image src={branchImage} alt={`${branchName} branch`} fill className="object-cover transition duration-500 group-hover:scale-105" />
                    <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent p-4 text-white">
                      ...
                      {branch.isMainBranch && <p className="text-xs font-medium text-white/80">Main Branch</p>}
                    </div>
                  </div>
                      ...
                      {branch.phone && (
                        <div className="flex gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-gray-500">For reservations and inquiries</p>
                          </div>
                        </div>
                      )}
